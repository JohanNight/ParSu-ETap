...
<div class="relative min-h-screen bg-gradient from-gray-400"
    ...
    ">
    <header class="text-center mb-5 pt-2  bg-blue-700 h-20 w-full">
    ...
    <div class="flex flex-col items-center ">
        <div
            class="swiper-container relative w-[600px] h-[400px] overflow-hidden border-4 border-orange-500 rounded-md shadow-md ">
