...
<div class="relative">
    ...
    <div class=" min-h-screen w-full absolute">
        <x-messages />@include('partials.headerClient')
        ...
        <div class="relative">
            ...
            <!-- Background Image -->
            <div class="absolute w-full">
                <img src="{{ asset('images/ImageForPSU/IMG_2543.jpg') }}"
                    class="h-[100dvh] bg-no-repeat w-full opacity-80" alt="">
            </div>
            ...
            <div class="min-h-screen w-full absolute">
                ...
                <div class="flex flex-col gap-10">
                    ...
                    <div class="flex flex-col justify-evenly items-center mt-[40px] p-5 sm:flex-row">
                        <a href="{{ route('Step1') }}"
                            class="border-2 border-yellow-400 bg-yellow-400 rounded-lg text-4xl SemiB-font uppercase p-2 text-white border-2 border-black mb-5 sm:mr-[50px] active:bg-yellow-500">
                            Walk-In Survey
                        </a>
                        <a href="{{ route('clientSecurity') }}"
                            class="border-2 border-blue-800 bg-blue-800 rounded-lg text-4xl SemiB-font uppercase p-2 text-white border-2 border-black active:bg-blue-900 sm:text-center">
