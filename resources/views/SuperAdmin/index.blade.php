        ...
        <div class="flex-1 p-4 w-full md:w-1/2 bg-gray-200 min-h-screen">
            ...
            <div class="mt-6 flex flex-wrap space-x-0 space-y-2 md:space-x-4 md:space-y-0">
                ...
                <div class="flex-1 bg-white p-4 shadow rounded-lg md:w-1/2">
                    <h2 class="text-gray-500 text-lg SemiB-font pb-1 capitalize">Total Surveyed per Offices
                    </h2>
                    ...
                    <tbody>
                        @foreach ($services as $service)
                            <tr class="hover:bg-grey-lighter">
                                <td class="py-2 px-4 border-b border-grey-light">{{ $service->serviceTitle }}</td>
